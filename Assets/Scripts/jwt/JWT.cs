...
namespace JWT
{
    ...
    public static class JsonWebToken
    {
        ...
        public static string Encode(object extraHeaders, object payload, byte[] key, JwtHashAlgorithm algorithm)
        {
            ...
            byte[] headerBytes = Encoding.UTF8.GetBytes(JsonSerializer.Serialize(extraHeaders));
        ...
        /// <param name="algorithm">The hash algorithm to use.</param>
        /// <returns>The generated JWT.</returns>
        public static string Encode(object extraHeaders, object payload, string key, JwtHashAlgorithm algorithm)
        {
        ...
        public static string Decode(string token, byte[] key, bool verify = true)
        {
            ...
            var headerData = JsonSerializer.Deserialize<myheaders>(headerJson);
